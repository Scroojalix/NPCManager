package me.scroojalix.npcmanager.nms.v1_9_R1;
...
import net.minecraft.server.v1_9_R1.ScoreboardTeamBase.EnumTeamPush;
...
public class NPCManager extends INPCManager {
	...
	public void getNMSEntity(NPCData data) {
		...
		npc.getDataWatcher().set(DataWatcherRegistry.a.a(12), (byte)127);
