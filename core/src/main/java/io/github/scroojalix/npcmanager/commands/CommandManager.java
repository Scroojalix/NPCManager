...
public class CommandManager implements TabExecutor {
    ...
    public CommandManager(NPCMain main) {
        ...
        // TODO equipment subcommand - customise npc equipment
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
		...
		case 2:
			result.clear();
			if (args[0].equalsIgnoreCase("remove") || args[0].equalsIgnoreCase("modify") || args[0].equalsIgnoreCase("move") || args[0].equalsIgnoreCase("info") || args[0].equalsIgnoreCase("tpto")) {
