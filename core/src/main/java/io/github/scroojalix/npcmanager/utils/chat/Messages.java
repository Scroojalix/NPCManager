...
public class Messages {
    ...
    public static String DATABASE_NOT_CONNECTED = "Could not connect to database. Check that the database is online and the login info is correct, then run /npc reload.";
