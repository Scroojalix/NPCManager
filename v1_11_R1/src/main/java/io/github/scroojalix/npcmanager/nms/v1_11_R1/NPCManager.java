package io.github.scroojalix.npcmanager.nms.v1_11_R1;
...
import net.minecraft.server.v1_11_R1.ScoreboardTeamBase.EnumTeamPush;
...
public class NPCManager extends INPCManager {
	...
	public void getNMSEntity(NPCData data) {
		...
		npc.getDataWatcher().set(DataWatcherRegistry.a.a(13), data.getTraits().getSkinLayersByte());
		data.setNPC(npc);
	}
